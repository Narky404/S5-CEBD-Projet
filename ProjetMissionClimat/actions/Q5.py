    ...
    def extract_data(self):
        ...
        try:
            ...
            result = cursor.execute("""
                SELECT DISTINCT code_departement, nom_departement, strftime('%Y', date_mesure) as annee, ROUND(avg(temperature_moy_mesure), 2) AS moyenne, min(temperature_min_mesure) AS minimum, max(temperature_max_mesure) AS maximum
            ...
            for resultat in result:
                tab.append( [resultat[0], resultat[1], resultat[2], resultat[3], resultat[4], resultat[5]] )
