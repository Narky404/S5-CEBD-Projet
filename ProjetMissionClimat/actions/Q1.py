...
class Window(tk.Toplevel):
    def __init__(self, parent):
        ...
        #Consigne
        """Modifier cette fonction en s'inspirant du code de F1, pour qu'elle affiche la liste de départements (code_departement, nom_departement) de la zone climatique H1"""
